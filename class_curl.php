...
function fetch_value_header($str,$find_start,$find_end) {
...
class curl {
	...
	function getPage2($url, $hasHeader=true) {
		curl_setopt($this->ch, CURLOPT_HEADER, $hasHeader ? 0 : 1);
		curl_setopt ($this->ch, CURLOPT_URL, $url);
...
function curl($url, $var = null, $cookies = null, $socks = null) {
	...
	//curl_setopt($curl, CURLOPT_PROXY, "http://127.0.0.1:8989");
